import{j as r,q as w,k as g,g as n,X as E,P as D,T as M,Q as F}from"./index-CVC6aYCP.js";import{A as O}from"./AdminTable-D98Ucc_T.js";import{C as Z}from"./chevron-down-4HvzhmSS.js";import{F as q,T as I}from"./TableFilters-DOmxPRAL.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S,D as R}from"./FormInput-WwoL0yFH.js";import{E as T}from"./eye-BcmpNpIl.js";import{P as L}from"./pencil-DpZ5gZLf.js";import"./input-IUXUfpfv.js";import"./search-DVVcTjPd.js";import"./triangle-alert-CR2Dq__W.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function B({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
