import{j as r,o as w,k as g,g as n,X as E,P as D,T as M,Q as F}from"./index-B8BFCSo4.js";import{A as O}from"./AdminTable-YAzwE1Cg.js";import{C as Z}from"./chevron-down-CK2bSHRd.js";import{F as I,T as R}from"./TableFilters-BywYmsQT.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S,D as T}from"./FormInput-B0sXPu9Y.js";import{E as q}from"./eye-DYmt_B26.js";import{P as L}from"./pencil-CUOC-i_h.js";import"./input-CD0NcPnl.js";import"./search-BSdkoPDD.js";import"./triangle-alert-DSDwoTDt.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function B({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
