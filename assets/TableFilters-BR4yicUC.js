import{g as d,j as e,q as m,k as x}from"./index-CqrAp8fu.js";import{C as p}from"./chevron-down-BzZq4y6D.js";import{I as u}from"./input-COsLzOhg.js";import{S as f}from"./search-QbaNTlEl.js";function b({label:n,value:t,options:o,onChange:i,className:c="",containerClassname:l=""}){const[a,s]=d.useState(!1);return e.jsxs("div",{className:`relative flex flex-col gap-2 ${l||"w-52"}`,children:[e.jsx("p",{className:"text-sm",children:n}),e.jsxs("button",{type:"button",onClick:()=>s(!a),className:`
          w-full
