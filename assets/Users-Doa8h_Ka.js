import{j as r,q as w,k as g,g as n,X as E,P as D,T as M,Q as F}from"./index-CXQIVBmT.js";import{A as O}from"./AdminTable-CnzCIg8r.js";import{C as Z}from"./chevron-down-0KHA9J--.js";import{F as q,T as I}from"./TableFilters-DBmQVPYk.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S,D as R}from"./FormInput-DGBEu5VJ.js";import{E as T}from"./eye-DZSAIBW3.js";import{P as L}from"./pencil-CvNPxlE2.js";import"./input-Dz7wE7uE.js";import"./search-Cwo2JfDr.js";import"./triangle-alert-Bs4OpWzR.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function B({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
