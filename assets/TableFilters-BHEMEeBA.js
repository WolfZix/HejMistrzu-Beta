import{g as d,j as e,q as m,k as x}from"./index-CsxOrmNg.js";import{C as p}from"./chevron-down-DRNUugjH.js";import{I as u}from"./input-C2OYJz1I.js";import{S as f}from"./search-BHZgK9oY.js";function b({label:n,value:t,options:o,onChange:i,className:c="",containerClassname:l=""}){const[a,s]=d.useState(!1);return e.jsxs("div",{className:`relative flex flex-col gap-2 ${l||"w-52"}`,children:[e.jsx("p",{className:"text-sm",children:n}),e.jsxs("button",{type:"button",onClick:()=>s(!a),className:`
          w-full
