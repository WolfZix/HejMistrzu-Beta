import{j as r,q as w,k as g,g as n,X as E,P as D,T as M,Q as F}from"./index-CsxOrmNg.js";import{A as O}from"./AdminTable-BttIDPe0.js";import{C as Z}from"./chevron-down-DRNUugjH.js";import{F as q,T as I}from"./TableFilters-BHEMEeBA.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S,D as R}from"./FormInput-2slWdGSw.js";import{E as T}from"./eye-D-48pSb0.js";import{P as L}from"./pencil-DBiMEIzP.js";import"./input-C2OYJz1I.js";import"./search-BHZgK9oY.js";import"./triangle-alert-CgN6k3aK.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function B({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
