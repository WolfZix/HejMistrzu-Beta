import{j as e,g as o,o as _,k as v,X as A,P as D,V as q,W as Z}from"./index-D80TAC32.js";import{F as E,T as B,A as R,D as W}from"./TableFilters-afbaL8ni.js";import{F as f}from"./FormInput-DAWMsb3K.js";import{n as M}from"./index-WQ0BBVcu.js";import{T as K}from"./triangle-alert-CxYi6MMF.js";import{P as G}from"./pencil-tEmp6kVr.js";import"./chevron-down-b5b4W_BD.js";import"./input-BXjwQCEJ.js";import"./search-D90LdhXw.js";function U({label:n,value:t,onChange:s,placeholder:i="",rows:l=4,required:d=!1,className:u=""}){return e.jsxs("div",{className:`flex flex-col gap-2 w-full ${u}`,children:[e.jsxs("label",{className:"text-sm",children:[n,d&&e.jsx("span",{className:"text-red-500",children:" *"})]}),e.jsx("textarea",{value:t,rows:l,placeholder:i,onChange:c=>s(c.target.value),className:`\r
          w-full\r
          p-3\r
          rounded-lg\r
          bg-background/50\r
          ...
          `,children:[e.jsx(D,{size:18})," Dodaj Produkt"]})}),e.jsxs("div",{className:"h-[34rem] flex flex-col justify-between",children:[e.jsxs(R,{children:[e.jsx("thead",{children:e.jsxs("tr",{className:"border-b border-border text-primary text-center",children:[e.jsx("th",{className:"p-4 w-20",children:"ID"}),e.jsx("th",{className:"p-4 w-[45%]",children:"Produkt"}),e.jsx("th",{className:"p-4 w-[20%]",children:"Kategoria"}),e.jsx("th",{className:"p-4 w-32",children:"Cena"}),e.jsx("th",{className:"p-4 w-40",children:"Magazyn: szt."}),e.jsx("th",{className:"p-4 w-20",children:"Status"}),e.jsx("th",{className:"p-4 w-28",children:"Akcje"})]})}),e.jsx("tbody",{children:O.map(r=>{var m,S,z;return e.jsxs("tr",{className:`\r
                ...
                `,children:[e.jsx("td",{className:"p-4",children:r.id}),e.jsx("td",{className:"p-4",children:e.jsxs("div",{className:"relative group",children:[e.jsx("div",{className:"truncate",children:r.name}),e.jsx("div",{className:`\r
                      ...
                      `,children:r.name})]})}),e.jsx("td",{className:"p-4",children:e.jsxs("div",{className:"relative group",children:[e.jsx("div",{className:"truncate",children:((m=r.categories.at(-1))==null?void 0:m.name)||"-"}),e.jsx("div",{className:`\r
                        ...
                        whitespace-nowrap\r
                        shadow-lg\r
                      `,children:((S=r.categories.at(-1))==null?void 0:S.name)||"-"})]})}),e.jsxs("td",{className:"p-4 text-nowrap",children:[r.price.toFixed(2)," zł "," ",e.jsx("span",{className:"text-muted-foreground line-through text-sm",children:r.onSale?((z=r.regularPrice)==null?void 0:z.toFixed(2))+" zł":""})]}),e.jsx("td",{className:"p-4",children:e.jsx("div",{className:"flex justify-center gap-1",children:e.jsxs("span",{className:`flex gap-1 items-center ${$(r.stock)}`,children:[r.stock<5?e.jsx(K,{size:14}):"",r.stock]})})}),e.jsx("td",{className:"p-4",children:e.jsx("div",{className:"flex justify-center gap-1",children:e.jsx("span",{className:`px-2 py-1 rounded-md text-xs font-medium
