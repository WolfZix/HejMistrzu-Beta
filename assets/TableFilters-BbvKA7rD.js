import{g as d,j as e,o as m,k as x}from"./index-BS5mKwd6.js";import{C as p}from"./chevron-down-C-Re-DoV.js";import{I as u}from"./input-BfmlkSe-.js";import{S as f}from"./search-DhEY0KiN.js";function b({label:n,value:t,options:o,onChange:i,className:c="",containerClassname:l=""}){const[a,s]=d.useState(!1);return e.jsxs("div",{className:`relative flex flex-col gap-2 ${l||"w-52"}`,children:[e.jsx("p",{className:"text-sm",children:n}),e.jsxs("button",{type:"button",onClick:()=>s(!a),className:`
          w-full
