import{j as e,q as w,k as g,g as n,X as E,P as D,U as M,V as F}from"./index-C_QLmIC9.js";import{A as O,P as Z}from"./AdminTable-CXh4nhTF.js";import{C as q}from"./chevron-down-CRIsPdY7.js";import{F as I,T as R}from"./TableFilters-DlYaRLmk.js";import{n as v}from"./index-Bc4rgiU6.js";import{F as S,D as T}from"./FormInput-74BFKpDI.js";import{E as L}from"./eye-CVL9BR8g.js";import"./input-u3QqF4L6.js";import"./search-Ch7CNiob.js";import"./triangle-alert-DRfEZMVD.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function V({username:a,setUsername:s,email:u,setEmail:d,password:l,setPassword:t,role:c,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return e.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),e.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
          ...
          `,children:"Anuluj"}),e.jsx("button",{type:"submit",className:`\r
            ...
            transition-all\r
            duration-200\r
          `,children:"Zapisz"})]})]})}function G({isOpen:a,user:s,onClose:u}){const[d,l]=n.useState({username:"",email:"",role:"user"});n.useEffect(()=>{s&&l({username:s.username,email:s.email,role:s.role})},[s]),n.useEffect(()=>(document.body.style.overflow=a?"hidden":"auto",()=>{document.body.style.overflow="auto"}),[a]);function t(){l({username:"",email:"",role:"user"}),u()}function c(i){i.preventDefault(),console.log(d),t()}return e.jsx(w,{children:a&&e.jsx(g.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onMouseDown:t,className:`\r
            fixed\r
            inset-0\r
            z-50\r
            flex\r
