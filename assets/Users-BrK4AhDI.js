import{j as r,q as w,k as g,g as n,X as E,P as D,T as M,Q as F}from"./index-BPh0_T7i.js";import{A as O}from"./AdminTable-B6xB75kG.js";import{C as Z}from"./chevron-down-BjUr2KQh.js";import{F as q,T as I}from"./TableFilters-BMND1Ksa.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S,D as R}from"./FormInput-BCRGiqp8.js";import{E as T}from"./eye-Bu_Tgps8.js";import{P as L}from"./pencil-CEgPABey.js";import"./input-CAIEsuek.js";import"./search-bB6GFTH9.js";import"./triangle-alert-BcX4fgoW.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function B({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
