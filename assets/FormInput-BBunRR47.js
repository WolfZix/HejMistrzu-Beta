import{j as r,q as d,k as l,X as x}from"./index-CqrAp8fu.js";import{T as u}from"./triangle-alert-qQM8tyGf.js";function b({isOpen:s,title:t,description:a,onClose:n,onConfirm:i}){return r.jsx(d,{children:s&&r.jsx(l.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onMouseDown:n,className:`\r
            fixed\r
            inset-0\r
            z-50\r
            flex\r
