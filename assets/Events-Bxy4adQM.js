import{g as a,j as r,q as z,k as w,X as D,P as E,T as P,Q as T}from"./index-XQaRl8-6.js";import{A as _}from"./AdminTable-C8Vpkt5X.js";import{C as M}from"./chevron-down-CRQNae39.js";import{e as S}from"./events-Dlv7-aJY.js";import{n as C}from"./index-WQ0BBVcu.js";import{T as A}from"./TableFilters-B6qLNWLr.js";import{E as q}from"./eye-B6do1vJ3.js";import{P as I}from"./pencil-CIpSfIvL.js";import"./BoardGames-YYkGj3Z5.js";import"./input-BZfMsokZ.js";import"./search-Bb-CkudI.js";const O=["Magic","Pokemon","Warhammer","RPG","Inne"];function Z({title:o,setTitle:p,description:u,setDescription:m,category:l,setCategory:i,date:b,setDate:d,time:f,setTime:s,price:c,setPrice:x,totalSlots:y,setTotalSlots:e,handleSubmit:t,closeModal:v}){const[h,g]=a.useState(!1);return r.jsxs("form",{onSubmit:t,className:"flex flex-col space-y-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Tytuł"}),r.jsx("input",{required:!0,type:"text",value:o,onChange:n=>p(n.target.value),className:`\r
        w-full\r
        bg-background/50\r
