import{j as e,q as w,k as g,g as n,X as E,P as D,U as M,V as F}from"./index-CqrAp8fu.js";import{A as O,P as Z}from"./AdminTable-D-dIYzJM.js";import{C as q}from"./chevron-down-BzZq4y6D.js";import{F as I,T as R}from"./TableFilters-BR4yicUC.js";import{n as v}from"./index-Bc4rgiU6.js";import{F as S,D as T}from"./FormInput-BBunRR47.js";import{E as L}from"./eye-DWiiCss_.js";import"./input-COsLzOhg.js";import"./search-QbaNTlEl.js";import"./triangle-alert-qQM8tyGf.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function V({username:a,setUsername:s,email:u,setEmail:d,password:l,setPassword:t,role:c,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return e.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),e.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
