import{g as a,j as r,q as z,k as w,X as D,P as E,U as P,V as T}from"./index-epBis1f4.js";import{A as _,P as M}from"./AdminTable-BDBuOqcl.js";import{C as A}from"./chevron-down-CGBKQSIk.js";import{e as S}from"./events-ON0TXdEl.js";import{n as C}from"./index-Bc4rgiU6.js";import{T as q}from"./TableFilters-CYCFxsXJ.js";import{E as I}from"./eye-Dp3Duvtp.js";import"./BoardGames-YYkGj3Z5.js";import"./input-DZBS2U-0.js";import"./search-CSZikc-c.js";const O=["Magic","Pokemon","Warhammer","RPG","Planszówki"];function Z({title:o,setTitle:p,description:u,setDescription:m,category:l,setCategory:i,date:b,setDate:d,time:f,setTime:s,price:c,setPrice:x,totalSlots:y,setTotalSlots:e,handleSubmit:t,closeModal:v}){const[h,g]=a.useState(!1);return r.jsxs("form",{onSubmit:t,className:"flex flex-col space-y-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Tytuł"}),r.jsx("input",{required:!0,type:"text",value:o,onChange:n=>p(n.target.value),className:`\r
        w-full\r
        bg-background/50\r
