import{j as r,o as w,k as g,g as n,X as E,P as D,V as M,W as F}from"./index-Bx_s5XN0.js";import{F as O,T as Z,A as I,D as R}from"./TableFilters-vbfBWVon.js";import{C as q}from"./chevron-down-CmNb_3Ln.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S}from"./FormInput-V-pj4GZX.js";import{E as T}from"./eye-BfERMHlg.js";import{P as L}from"./pencil-CL-XWLyv.js";import"./triangle-alert-BwC6NDBH.js";import"./input-DiecwIuW.js";import"./search-BdF6ZZDU.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function V({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
          ...
          `,children:[r.jsx("span",{children:(m=z.find(o=>o.value===u))==null?void 0:m.label}),r.jsx(q,{size:18,className:`transition-transform ${f?"rotate-180":""}`})]}),r.jsx(w,{children:f&&r.jsx(g.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.2},className:`\r
                absolute\r
                top-full\r
                mt-1\r
                z-50\r
