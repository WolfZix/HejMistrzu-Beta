import{j as r,q as v,k as y,g as s,X as N,P as k,U as w,V as U}from"./index-B8C75r4p.js";import{A as z,P as C}from"./AdminTable-C8b5sRLb.js";import{C as P}from"./chevron-down-CcnKKfY7.js";import{S}from"./search-B_aMiBJA.js";const g=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function _({username:a,setUsername:m,email:t,setEmail:l,password:o,setPassword:i,role:c,setRole:e,isRoleOpen:p,setIsRoleOpen:u,handleSubmit:h,closeModal:b}){var d;return r.jsxs("form",{onSubmit:h,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:n=>m(n.target.value),className:`\r
            w-full\r
            bg-background/50\r
