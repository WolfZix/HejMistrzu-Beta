import{g as d,j as e,q as m,k as x}from"./index-DbR80N_O.js";import{C as p}from"./chevron-down-CyGI-Fj6.js";import{I as u}from"./input-B2gI6d6l.js";import{S as f}from"./search-sFTwBcS_.js";function b({label:n,value:t,options:o,onChange:i,className:c="",containerClassname:l=""}){const[a,s]=d.useState(!1);return e.jsxs("div",{className:`relative flex flex-col gap-2 ${l||"w-52"}`,children:[e.jsx("p",{className:"text-sm",children:n}),e.jsxs("button",{type:"button",onClick:()=>s(!a),className:`
          w-full
