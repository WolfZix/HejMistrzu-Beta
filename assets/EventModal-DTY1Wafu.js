 ...
 */const D=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]],E=w("CircleAlert",D);function R({event:n,freeSlots:l,onClose:h}){const[t,p]=x.useState(1),[o,u]=x.useState(!1),[d,f]=x.useState("idle"),[a,j]=x.useState({firstName:"",lastName:"",pokemonId:"",email:"",nickname:""}),[s,b]=x.useState({firstName:"",lastName:"",pokemonId:"",email:"",nickname:""}),c=(r,m)=>{f("idle"),j(i=>({...i,[r]:m})),b(i=>({...i,[r]:""}))};function N(){const r={firstName:"",lastName:"",pokemonId:"",email:"",nickname:""},m=/^[A-ZĄĆĘŁŃÓŚŹŻ][a-ząćęłńóśźż]+(?:-[A-ZĄĆĘŁŃÓŚŹŻ][a-ząćęłńóśźż]+)?$/,i=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,g=/^\d+$/;return m.test(a.firstName)||(r.firstName="Imię powinno zaczynać się z wielkiej litery!"),m.test(a.lastName)||(r.lastName="Nazwisko powinno zaczynać się z wielkiej litery!"),g.test(a.pokemonId)||(r.pokemonId="Pokemon ID może zawierać tylko cyfry"),i.test(a.email)||(r.email="Niepoprawny adres email"),b(r),r.firstName||r.lastName||r.pokemonId||r.email?r:null}async function y(r){if(r.preventDefault(),f("idle"),N())return;u(!0),await new Promise(k=>setTimeout(k,2e3)),u(!1);const i={eventId:n.id,firstName:a.firstName,lastName:a.lastName,pokemonId:a.pokemonId,email:a.email,slots:t};await(await fetch("http://localhost:3000/reservations",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)})).json()}return e.jsxs("form",{onSubmit:y,children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4 mb-4",children:[e.jsxs("div",{children:[e.jsx("input",{required:!0,type:"text",value:a.firstName,onChange:r=>c("firstName",r.target.value),placeholder:"Imię",className:`\r
        ...
        `,children:[e.jsxs("p",{className:"text-xl font-semibold",children:["Razem:",e.jsxs("span",{className:"text-primary text-2xl ml-2",children:[n.price*t,"zł"]})]}),e.jsxs("div",{className:"flex w-full md:w-auto gap-2",children:[e.jsx("button",{type:"button",onClick:h,className:"px-4 py-2 w-full border rounded hover:bg-muted-foreground/20 transition-all duration-300",children:"Anuluj"}),e.jsx("button",{type:"submit",disabled:o,className:`\r
            ...
            `,children:o?"Wysyłanie...":"Zarezerwuj"})]})]})]})}function L({event:n,onClose:l,months:h}){const t=new Date(n.date),p=t.getDate(),o=h[t.getMonth()+1].name,u=t.getFullYear(),d=n.totalSlots-n.bookedSlots;return e.jsx("div",{onClick:l,className:"fixed inset-0 bg-black/70 flex items-center justify-center z-50",children:e.jsxs("div",{onClick:f=>f.stopPropagation(),className:`\r
      bg-card\r
      w-[95vw] max-w-2xl\r
      max-h-[90vh]\r
      overflow-y-auto\r
    ...
    `,children:[e.jsx("button",{onClick:l,className:"absolute top-2 right-2 z-50 p-2 rounded-full bg-background/80 backdrop-blur border border-border hover:bg-background transition-colors",children:e.jsx(v,{className:"w-4 h-4"})}),e.jsxs("div",{className:"z-20",children:[e.jsxs("div",{children:[e.jsx("p",{className:"font-heading text-lg md:text-2xl font-bold tracking-wide line-clamp-2",children:n.title}),e.jsx("p",{className:"text-muted-foreground text-sm md:text-base mb-4",children:n.description})]}),e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1 mb-4 text-sm",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsxs("p",{className:"flex gap-2 w-fit",children:[e.jsx(I,{size:18,className:"text-primary"}),"Data: ",p," ",o," ",u]}),e.jsxs("p",{className:"flex gap-2 w-fit",children:[e.jsx(S,{size:18,className:"text-primary"}),"Wolne miejsca: ",d]})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsxs("p",{className:"flex gap-2 w-fit",children:[e.jsx(z,{size:18,className:"text-primary"}),"Godzina: ",n.startTime]}),e.jsxs("p",{className:"flex gap-2 w-fit",children:[e.jsx(_,{size:18,className:"text-primary"}),"Cena: ",n.price,"zł"]})]})]}),e.jsx(R,{event:n,freeSlots:d,onClose:l})]}),e.jsx("img",{src:n.image,className:`\r
