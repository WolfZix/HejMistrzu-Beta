import{j as r,o as k,k as g,g as n,X as E,P as D,V as M,W as F}from"./index-D80TAC32.js";import{F as O,T as Z,A as I,D as R}from"./TableFilters-afbaL8ni.js";import{C as q}from"./chevron-down-b5b4W_BD.js";import{n as v}from"./index-WQ0BBVcu.js";import{F as S}from"./FormInput-DAWMsb3K.js";import{E as T}from"./eye-Dswy3V8N.js";import{P as L}from"./pencil-tEmp6kVr.js";import"./triangle-alert-CxYi6MMF.js";import"./input-BXjwQCEJ.js";import"./search-D90LdhXw.js";const z=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function V({username:a,setUsername:s,email:c,setEmail:d,password:l,setPassword:t,role:u,setRole:i,isRoleOpen:f,setIsRoleOpen:j,handleSubmit:y,closeModal:x}){var m;return r.jsxs("form",{onSubmit:y,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:o=>s(o.target.value),className:`\r
            w-full\r
            bg-background/50\r
          ...
          `,children:[r.jsx("span",{children:(m=z.find(o=>o.value===u))==null?void 0:m.label}),r.jsx(q,{size:18,className:`transition-transform ${f?"rotate-180":""}`})]}),r.jsx(k,{children:f&&r.jsx(g.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.2},className:`\r
                absolute\r
                top-full\r
                mt-1\r
                z-50\r
          ...
          `,children:"Anuluj"}),r.jsx("button",{type:"submit",className:`\r
            ...
            `,children:"Dodaj"})]})]})}function W({isOpen:a,onClose:s}){const[c,d]=n.useState(""),[l,t]=n.useState(""),[u,i]=n.useState(""),[f,j]=n.useState("user"),[y,x]=n.useState(!1);n.useEffect(()=>(document.body.style.overflow=a?"hidden":"auto",()=>{document.body.style.overflow="auto"}),[a]);function m(){d(""),t(""),i(""),j("user"),x(!1),s()}function o(b){b.preventDefault(),m()}return r.jsx(k,{children:a&&r.jsx(g.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onMouseDown:m,className:`\r
            fixed\r
            inset-0\r
            z-50\r
            flex\r
          ...
          `,children:r.jsxs(g.div,{initial:{opacity:0,scale:.5},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.5},transition:{duration:.2},onClick:b=>b.stopPropagation(),onMouseDown:b=>b.stopPropagation(),className:`\r
            ...
            `,children:[r.jsx("button",{type:"button",onClick:m,className:`\r
                ...
                rounded-lg\r
                hover:bg-muted/30\r
              `,children:r.jsx(E,{size:18})}),r.jsx("div",{className:"mb-6",children:r.jsx("h2",{className:"font-heading text-center text-2xl font-semibold",children:"Dodaj użytkownika"})}),r.jsx(V,{username:c,setUsername:d,email:l,setEmail:t,password:u,setPassword:i,role:f,setRole:j,isRoleOpen:y,setIsRoleOpen:x,handleSubmit:o,closeModal:m})]})})})}function B({formData:a,setFormData:s,handleSubmit:c,closeModal:d}){return r.jsxs("form",{onSubmit:c,className:"flex flex-col gap-4",children:[r.jsx("div",{className:"flex gap-4 items-end justify-between",children:r.jsxs("div",{className:"flex flex-col gap-4 w-full",children:[r.jsx(S,{label:"Nazwa użytkownika",value:a.username,onChange:l=>s(t=>({...t,username:l})),placeholder:"WolfZix",required:!0}),r.jsx(S,{label:"Email",value:a.email,onChange:l=>s(t=>({...t,email:l})),placeholder:"user@example.com",type:"email",required:!0}),r.jsx(O,{label:"Rola",value:a.role,onChange:l=>s(t=>({...t,role:l})),options:[{value:"admin",label:"Administrator"},{value:"user",label:"Użytkownik"}]})]})}),r.jsxs("div",{className:"flex gap-3 pt-2",children:[r.jsx("button",{type:"button",onClick:d,className:`\r
            flex-1\r
            py-2\r
            rounded-md\r
            border\r
          ...
          `,children:"Anuluj"}),r.jsx("button",{type:"submit",className:`\r
            ...
            transition-all\r
            duration-200\r
          `,children:"Zapisz"})]})]})}function $({isOpen:a,user:s,onClose:c}){const[d,l]=n.useState({username:"",email:"",role:"user"});n.useEffect(()=>{s&&l({username:s.username,email:s.email,role:s.role})},[s]),n.useEffect(()=>(document.body.style.overflow=a?"hidden":"auto",()=>{document.body.style.overflow="auto"}),[a]);function t(){l({username:"",email:"",role:"user"}),c()}function u(i){i.preventDefault(),t()}return r.jsx(k,{children:a&&r.jsx(g.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onMouseDown:t,className:`\r
            fixed\r
            inset-0\r
            z-50\r
            flex\r
