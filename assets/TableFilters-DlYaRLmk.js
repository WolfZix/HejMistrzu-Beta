import{g as d,j as e,q as m,k as x}from"./index-C_QLmIC9.js";import{C as p}from"./chevron-down-CRIsPdY7.js";import{I as u}from"./input-u3QqF4L6.js";import{S as f}from"./search-Ch7CNiob.js";function b({label:n,value:t,options:o,onChange:i,className:c="",containerClassname:l=""}){const[a,s]=d.useState(!1);return e.jsxs("div",{className:`relative flex flex-col gap-2 ${l||"w-52"}`,children:[e.jsx("p",{className:"text-sm",children:n}),e.jsxs("button",{type:"button",onClick:()=>s(!a),className:`
          w-full
