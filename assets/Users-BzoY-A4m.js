import{j as r,q as v,k as y,g as s,X as N,P as k,U as w,V as U}from"./index-DXiJPbas.js";import{A as z,P as C}from"./AdminTable-BKyIlA65.js";import{C as P}from"./chevron-down-CJKom_Bq.js";import{S}from"./search-D6Jd0yPq.js";const g=[{value:"user",label:"Użytkownik"},{value:"admin",label:"Administrator"}];function _({username:a,setUsername:m,email:t,setEmail:l,password:o,setPassword:i,role:c,setRole:e,isRoleOpen:p,setIsRoleOpen:u,handleSubmit:h,closeModal:b}){var d;return r.jsxs("form",{onSubmit:h,className:"flex flex-col gap-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Nazwa użytkownika"}),r.jsx("input",{required:!0,type:"text",value:a,onChange:n=>m(n.target.value),className:`\r
            w-full\r
            bg-background/50\r
