import{g as a,j as r,q as z,k as w,X as D,P as E,U as P,V as T}from"./index-CqrAp8fu.js";import{A as _,P as M}from"./AdminTable-D-dIYzJM.js";import{C as A}from"./chevron-down-BzZq4y6D.js";import{e as S}from"./events-D2GIhWbm.js";import{n as C}from"./index-Bc4rgiU6.js";import{T as q}from"./TableFilters-BR4yicUC.js";import{E as I}from"./eye-DWiiCss_.js";import"./BoardGames-DR1MmYjU.js";import"./input-COsLzOhg.js";import"./search-QbaNTlEl.js";const O=["Magic","Pokemon","Warhammer","RPG","Planszówki"];function Z({title:o,setTitle:p,description:u,setDescription:m,category:l,setCategory:i,date:b,setDate:d,time:f,setTime:s,price:c,setPrice:x,totalSlots:y,setTotalSlots:e,handleSubmit:t,closeModal:v}){const[h,g]=a.useState(!1);return r.jsxs("form",{onSubmit:t,className:"flex flex-col space-y-4",children:[r.jsxs("div",{children:[r.jsx("label",{className:"mb-1 block",children:"Tytuł"}),r.jsx("input",{required:!0,type:"text",value:o,onChange:n=>p(n.target.value),className:`\r
        w-full\r
        bg-background/50\r
